...
public class wsSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ws_signup);
    ...
    private void navigate2login(){
        Intent home = new Intent(wsSignup.this,MainActivity.class);
        startActivity(home);
        finish();
    }
    ...
    private void handleSignUp(){
        Thread t2 = new Thread(){
            ...
            public void run() {
                ...
                Call<Void> call = retrofitInterface.executeWSSignup(hp);
                call.enqueue(new Callback<Void>() {
                    @Override
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        if(response.code()==200){
                            Toast.makeText(wsSignup.this,
                                    "Signed up successfully", Toast.LENGTH_LONG).show();
                            Intent home = new Intent(wsSignup.this,dummyactivity.class);
                            startActivity(home);
                            finish();
                    ...
                    public void onFailure(Call<Void> call, Throwable t) {
                        Toast.makeText(wsSignup.this, t.getMessage(),
